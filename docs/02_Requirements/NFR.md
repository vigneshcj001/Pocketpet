...
| NFR-6 | Security | Keys only in Credential Manager; all provider traffic from Rust; CSP `default-src 'self'; connect-src ipc: http://ipc.localhost`; updates only from GitHub hosts. | code review, `09_Security` |
...
| NFR-10 | Compatibility | Windows 10 21H2+ / 11 x64; WebView2 Evergreen; Edge/Chrome/Brave for the driver. | install matrix |
